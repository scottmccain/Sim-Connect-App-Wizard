...
function GetTargetName(strName, strProjectName) {
    try {
        ...
        if (strName == 'dialog.cpp')
            strTarget = 'DialogBase.cpp';

        if (strName == 'dialog.h')
            strTarget = 'DialogBase.h';

        if (strName == 'simconnectapp.cpp')
            strTarget = 'SimConnectApp.cpp';

        if (strName == 'simconnectapp.h')
            strTarget = 'SimConnectApp.h';
